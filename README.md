...
from the root directory of this project:
    ...
    docker run --rm -v /$(pwd):/home/breast_cancer_reccurence_predictor make -C /home/breast_cancer_reccurence_predictor all

To reset the repo to a clean state, with no intermediate or results
files, run the following command at the command line/terminal from the
root directory of this project:

    docker run --rm -v /$(pwd):/home/breast_cancer_reccurence_predictor make -C /home/breast_cancer_reccurence_predictor clean
