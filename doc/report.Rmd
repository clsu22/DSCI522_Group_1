...
```{r figure1, echo=FALSE, fig.cap="Figure 1. Breast cancer recurrence is related to age and average tumor size in the training data set.", out.width = '100%'}
