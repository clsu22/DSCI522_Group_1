...
def test_threshold(model, t, X, y):
    ...
    score_result["accuracy"].append(accuracy_score(y, preds))
    score_result["recall"].append(recall_score(y, preds))
    score_result["precision"].append(precision_score(y, preds))
    score_result["roc_auc_score"].append(roc_auc_score(y, preds))
    score_result["f1_score"].append(f1_score(y, preds))
